% This code is written by Mainak Mallick
% Student of Aerospace Engineering and Applied Mechanics,IIEST Shibpur
%Followed the source panel method provide in the book J.D Anderson
%The text file can be downloaded from http://airfoiltools.com/plotter/index?airfoil=naca2412-il
clc;
clear all;
close all;
